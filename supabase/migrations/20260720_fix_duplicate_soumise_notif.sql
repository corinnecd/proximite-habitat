-- =============================================================================
-- Fix : purger les anciennes FICHE_SOUMISE avant de réinsérer
-- Évite les doublons quand une fiche est re-soumise après rejet en BROUILLON
-- =============================================================================
...
begin
  ...
  -- SOUMISE → purger les anciennes notifs de soumission pour cette fiche,
  -- puis notifier les admins (évite les doublons si re-soumission après rejet)
  if p_new_status = 'SOUMISE' then
    delete from public.notifications
    where fiche_id = p_fiche_id and type = 'FICHE_SOUMISE';
