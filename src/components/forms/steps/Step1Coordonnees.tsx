...
export function Step1Coordonnees({ currentFicheId }: { currentFicheId?: string }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="space-y-2"><Label>Date de visite</Label><Input type="date" className="h-12 bg-card" onKeyDown={(e) => e.preventDefault()} {...register("date_visite")} /></div>
      ...
      <div className="border-t border-border pt-5 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input type="date" className="h-12 bg-card" onKeyDown={(e) => e.preventDefault()} {...register("rdv_date")} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="space-y-2">
