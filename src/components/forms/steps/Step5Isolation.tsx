...
export function Step5Isolation() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-4"><div className="w-10 h-10 rounded-xl bg-green-100 flex items-center justify-center"><Shield className="w-5 h-5 text-green-600" /></div><div><h3 className="font-heading text-xl">Isolation</h3><p className="text-sm text-muted-foreground">Nature et état</p></div></div>
      <Multi label="Nature de l'isolant" options={NATURE_ISOLANT} field="nature_isolant" />
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="space-y-2"><Label>Âge</Label><Input placeholder="15 ans" className="h-12 bg-white" {...register("age_isolant")} /></div>
        <div className="space-y-2"><Label>Épaisseur</Label><Input placeholder="200 mm" className="h-12 bg-white" {...register("epaisseur_isolant")} /></div>
      </div>
      <div className="flex items-center gap-3 mt-8 mb-4"><div className="w-10 h-10 rounded-xl bg-amber-100 flex items-center justify-center"><HardHat className="w-5 h-5 text-amber-600" /></div><div><h3 className="font-heading text-xl">Toiture</h3><p className="text-sm text-muted-foreground">Type de pose et matériaux</p></div></div>
