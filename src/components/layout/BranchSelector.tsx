    ...
    <div className="px-3 pb-1">
      <div className="relative">
        ...
        <select
          ...
          className="w-full appearance-none bg-white text-[#1d1d1f] text-sm font-medium pl-9 pr-8 py-2 rounded-xl border border-[#ececec] hover:bg-black/4 transition-colors cursor-pointer focus:outline-none focus:ring-1 focus:ring-[#F97316]/50"
