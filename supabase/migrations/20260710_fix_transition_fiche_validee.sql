-- =============================================================================
-- Migration : correction de transition_fiche — rétablissement du statut VALIDEE
-- La migration 0007 avait écrasé la fonction et supprimé les transitions
-- SOUMISE → VALIDEE et VALIDEE → AFFECTEE. Ce fichier les rétablit.
-- =============================================================================
...
begin
  ...
  -- Affectation : commercial obligatoire et dans la même organisation
