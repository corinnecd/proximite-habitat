...
export function Step4Ventilation() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-4"><div className="w-10 h-10 rounded-xl bg-sky-100 flex items-center justify-center"><Wind className="w-5 h-5 text-sky-600" /></div><div><h3 className="font-heading text-xl font-semibold tracking-tight">Ventilation</h3><p className="text-sm text-muted-foreground">Système en place</p></div></div>
      ...
      <div className="space-y-2"><Label>Âge du système</Label><Input placeholder="10 ans" className="h-12 bg-card" {...register("age_ventilation")} /></div>
    </div>
  );
}
