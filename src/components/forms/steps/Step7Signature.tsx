...
export function Step7Signature({ signatureDataUrl, setSignatureDataUrl }: Step7Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-4"><div className="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center"><PenTool className="w-5 h-5 text-emerald-600" /></div><div><h3 className="font-heading text-xl">Signature & Validation</h3><p className="text-sm text-muted-foreground">Signature et consentement RGPD</p></div></div>
      <div className="space-y-3"><Label>Signature du prospect</Label><SignatureCanvas onSignatureChange={setSignatureDataUrl} /></div>
